...
knitr::include_graphics("HALLMARK_ANDROGEN_RESPONSE_ENST00000561519.png")
...
```{r, echo = FALSE, out.height = "50%", out.width="50%"}
knitr::include_graphics("ARLNC1_plot_example.png")
...
```{r, echo = FALSE, out.height = "50%", out.width="50%"}
knitr::include_graphics("ARLNC1_3cohorts_ht.png")
...
```{r, echo = FALSE, out.height = "50%", out.width="50%"}
knitr::include_graphics("multiple_lncRNA_prad.png")
...
```{r, echo = FALSE, out.height = "50%", out.width="50%"}
knitr::include_graphics("PB69.example.png")
```
